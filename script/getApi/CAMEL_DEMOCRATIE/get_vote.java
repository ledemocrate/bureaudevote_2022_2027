...
public class get_vote extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("jetty://http://0.0.0.0:1400/assemblee_nationale/get_vote")
		        .setBody(constant("SELECT identifiant, vote, loi, date FROM assemblee_representative.vote"))
